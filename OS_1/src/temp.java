...
static LinkedList<PCB> pausing_queue = new LinkedList<PCB>();
...
public static void main(String[] argvs)throws FileNotFoundException //Added
{
	...
	while(true)
	{
		...
		System.out.println("stop for stopping process");
...
public static void shortTermScheduling1()
{
...
public static void shortTermScheduling2(){
...
public static void shortTermScheduling4(){
